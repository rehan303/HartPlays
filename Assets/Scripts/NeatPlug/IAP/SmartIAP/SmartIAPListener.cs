...
public class SmartIAPListener : MonoBehaviour
{
	...
	public static bool ItemPurchased;
	public static bool PlayToWinSubscribe;
...
//		if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [0]) {
//			ItemPurchased = true;
//			BuyItemsForCololBallGame.Instance.IFBombPurchased ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [1]) {
//			ItemPurchased = true;
//			BuyItemsForCololBallGame.Instance.BuyFreezePowerUp ();
//		
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [2]) {
//			ItemPurchased = true;
//			BuyItemsForCololBallGame.Instance.BuyReminderPowerUp ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [3]) {
//			ItemPurchased = true;
//			BuyItemsForDodgerGame.Instance.BuyInvinciblePowerUp ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [4]) {
//			ItemPurchased = true;
//			BuyItemsForDodgerGame.Instance.BuyMergePowerUp ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [5]) {
//			ItemPurchased = true;
//			BuyItemsForDodgerGame.Instance.BuyBombPowerUp ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [6]) {
//			ItemPurchased = true;
//			BuyItemsForDodgerGame.Instance.BuySlowDownPowerUp ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [7]) {
//			ItemPurchased = true;
//			BuyItemsForNinjaFootieGame.Instance.BuyGoldenStarPowerUp ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [8]) {
//			ItemPurchased = true;
//			BuyItemsForNinjaFootieGame.Instance.BuyRhombusPowerUp ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [9]) {
//			ItemPurchased = true;
//			BuyItemsForNinjaFootieGame.Instance.BuySquarePowerUp ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [10]) {
//			ItemPurchased = true;
//			BuyItemsForNinjaFootieGame.Instance.BuyWhiteStarPowerUp ();
//		} else if (receipt.sku == HartPlays_InAppPurchase.Instance.proId [11]) {
//			PlayToWinSubscribe = true;
//			HartPlays_PlaytoWin_Subscribe.Instance.IFHartPlaysPlayToWinSubscribe ();
//		}
//		PlayToWinSubscribe = false;
//		ItemPurchased = false;
	}
